...
class MyModel():
    ...
    def set_indexes_case(self, Npts, nt):
        ind = pbe_msm_solver.Indexes([Npts], [nt - 1], [nt - 1], 0, 1)
        return ind
    ...
    def addition_crystals(self, t, y):
        # x = self.ind.get_x(y)
    ...
    def calc_mdl_rhs(self, t, y):
        ...
        N = self.ind.get_N(y, 0)
        NinOut = self.addition_crystals(t, y)
    ...
    def after_simulation(self, y, tspan, i_t):
        pbe_utils.remove_smallers_than_zero(y, self.ind, self.lmin, 0)
