...
def equilibrium(cNaHCO3, cCaCl2, QCaCl2, QNaHCO3, T):
    ...
    def ion_activity(I,TK):
        ...
        #Possivel erro, no eq. de NaHCO3 utiliza-se valores do outro
        # Por exemplo, chamando esta funcao do Equilibrio do NaHCO3
        # este loop utiliza-se os valores do CaCl2 para determinar valor do loggamma['H2O']
        m = 0.0
    ...
    pH = -c['H+']-loggamma['H+']
    print('pH after mixture = {}'.format(pH))
